...
describe("German humanization of duration", function() {
	...
	it("humanizes German singulars", function() {
	...
	it("humanizes German plurals", function() {
	...
	it("humanizes German when passed as an argument", function() {
		humanizing((1).second(), "de").should.equal("1 sekunde");
		humanizing((2).seconds(), "de").should.equal("2 sekunden");
		humanizing((5).years(), "de").should.equal("5 jahre");
	});

	it("humanizes German when the default language is changed", function() {
