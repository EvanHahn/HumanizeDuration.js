...
- [@visulima/humanizer](https://github.com/visulima/visulima/tree/main/packages/humanizer) - A maintend TypeScript fork with timeAdverb, abbreviated format and more
